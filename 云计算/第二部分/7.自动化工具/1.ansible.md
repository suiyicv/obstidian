...
本质上就是一个目录
一个角色一个需求，后期维护起来比较方便
![[Pasted image 20240626111351.png]]
cd /etc/ansible/roles
1.创建角色
ansible-gla

![[Pasted image 20240626111725.png]]
2.删除角色
rm -rf nginx/
...
tree zabbixAgent
vim /etc/ansible/role/nginx/tasks
	![[Pasted image 20240626112946.png]]
	![[Pasted image 20240626113022.png]]
cp /etc/zabbix ......      /etc/ansible   ..........    .j2
![[Pasted image 20240626113328.png]]
hostname  xxxxxxxxxx 变量


handler 写加载配置文件的操作
![[Pasted image 20240626113715.png]]
handler需要触发，需亚修改一下tasks
![[Pasted image 20240626113805.png]]

怎么执行角色里面的操作呢？
还需要写一个剧本
vim installzabbix,yaml
![[Pasted image 20240626113940.png]]
