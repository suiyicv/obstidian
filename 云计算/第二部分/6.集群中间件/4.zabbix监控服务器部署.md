...
vim /etc/zabbix/zabbix_agentd.conf 
UnsafeUserParameters=1
UserParameter=mysql.user.number,mysql -uroot -e "select count(*) from mysql.user" | sed '1d' | wc -l
...
#### (3)在web界面添加监控项
创建图形
![[Pasted image 20240624160157.png]]
...
### 3.创建动作
#### 3.1 条件/触发器
![[Pasted image 20240624193218.png|500]]
![[Pasted image 20240624193419.png|500]]

![[Pasted image 20240624193703.png]]
